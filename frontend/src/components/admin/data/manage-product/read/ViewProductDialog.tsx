...
import { SPECIFICATION_FIELDS } from '@/components/admin/data/manage-product/product.config'
...
// Component phụ trợ để hiển thị cặp Label - Value
        ...
        <div className='max-h-[80vh] overflow-y-auto px-6 pb-6 space-y-6'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex flex-col gap-1 mt-2'>
              ...
              <p className='text-sm p-3 bg-muted/20 border rounded-md min-h-[60px]'>
                {product.productDesc || (
              ...
              <div className='space-y-3'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-muted/30 rounded-lg border'>
                  {SPECIFICATION_FIELDS.map((field) => {
                    const specValue =
                      product.specification![field.id as keyof typeof product.specification]
                    ...
                    return (
                      <DetailItem
                        key={field.id}
                        label={t(`fields.specification.${field.label}`)}
                        value={specValue}
                      />
                    )
                  })}
          ...
          {/* 4. THÔNG TIN HỆ THỐNG (Ngày tạo, cập nhật) */}
