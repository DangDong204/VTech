...
import { deleteSoftProductApi } from '@/services/product/product.api'
...
export function DeleteProductDialog({ open, onOpenChange, product }: DeleteProductDialogProps) {
  ...
  const mutation = useAppMutation(
    () => deleteSoftProductApi(product.id),
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {t('message.confirm.softDelete', { productName: product.productName })}
          </AlertDialogDescription>
        </AlertDialogHeader>
