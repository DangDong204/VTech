import { CreateVoucherDialog } from '@/components/admin/data/manage-voucher/create/CreateVoucherDialog'
import { TrashVoucherDialog } from '@/components/admin/data/manage-voucher/trash/TrashVoucherDialog'
    ...
    <>
      <div className='flex flex-wrap items-center gap-2 py-4'>
        <Input
          ...
          onChange={(event) => table.getColumn('voucherCode')?.setFilterValue(event.target.value)}
        ...
        {isFiltered && (
          <Button variant='ghost' size='default' className='h-8' onClick={handleResetFilters}>
